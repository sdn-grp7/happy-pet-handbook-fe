...
/** Same layout as chatbox-fe: success green, error red. */
...
export function Toast({ id, message, type, onClose, duration = 4000 }: ToastProps) {
  ...
  return (
    <div
      className="animate-toast-slide-in relative min-w-[200px] max-w-[320px] overflow-hidden rounded-lg bg-card text-card-foreground shadow-lg border border-border"
      role="alert"

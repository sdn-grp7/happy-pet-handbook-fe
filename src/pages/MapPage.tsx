...
import { GoongMap, type GoongMapMarker } from "@/components/GoongMap";
import { PetImage } from "@/components/PetImage";
import { getPetPickupLocations } from "@/lib/mockApi";
...
export function MapPage() {
  ...
  return (
    <>
      <PageMeta
        title="Pickup Map — PawPath"
        description="Pet pickup locations on the map for adoption listings."
      />
      <PageHero
        eyebrow="Find a meetup spot"
        title="Pet pickup locations"
        subtitle="Chọn pet bên phải hoặc chạm pin trên bản đồ — cùng một điểm hẹn, cùng địa chỉ."
      />
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="text-xs text-muted-foreground mt-0.5">{p.pickup.address}</div>
